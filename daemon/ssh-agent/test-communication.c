...
#define ECDSA_SIGN_REQUEST "\x00\x00\x01\x47\x0d\x00\x00\x00\x68\x00\x00\x00\x13\x65\x63\x64" \
                           "\x73\x61\x2d\x73\x68\x61\x32\x2d\x6e\x69\x73\x74\x70\x32\x35\x36" \
                           "\x00\x00\x00\x08\x6e\x69\x73\x74\x70\x32\x35\x36\x00\x00\x00\x41" \
                           "\x04\xd8\x05\x32\x75\x64\x2a\x1a\xe4\x69\x4e\xc5\x85\x12\xc7\x2a" \
                           "\xcb\x70\xe9\x8a\xd7\x1d\x9e\x68\xd2\x19\xe8\x2a\xed\xf6\x66\xea" \
                           "\x74\x24\x27\xa0\xcf\xd1\x86\x01\x19\x52\x0d\xff\x2c\x85\x66\x0d" \
                           "\x8b\xe8\xc6\x1c\x9f\x9c\x22\x48\x2f\x9a\x2f\x76\xc7\x64\x0d\x88" \
                           "\x0a" \
                           "\x00\x00\x00\xd2\x00\x00\x00\x20\xfe\xc1\x79\x7e\x2f\xe3\x31\x5b" \
                           "\x80\x73\xd1\xe8\x0f\x15\x3d\x8d\x9b\x70\x14\x6c\x9c\xa1\xe8\x43" \
                           "\xa2\xb1\x56\x29\xdc\xa2\x65\xa1\x32\x00\x00\x00\x06\x6a\x6a\x65" \
                           "\x6c\x65\x6e\x00\x00\x00\x0e\x73\x73\x68\x2d\x63\x6f\x6e\x6e\x65" \
                           "\x63\x74\x69\x6f\x6e\x00\x00\x00\x09\x70\x75\x62\x6c\x69\x63\x6b" \
                           "\x65\x79\x01\x00\x00\x00\x13\x65\x63\x64\x73\x61\x2d\x73\x68\x61" \
                           "\x32\x2d\x6e\x69\x73\x74\x70\x32\x35\x36\x00\x00\x00\x68\x00\x00" \
                           "\x00\x13\x65\x63\x64\x73\x61\x2d\x73\x68\x61\x32\x2d\x6e\x69\x73" \
                           "\x74\x70\x32\x35\x36\x00\x00\x00\x08\x6e\x69\x73\x74\x70\x32\x35" \
                           "\x36\x00\x00\x00\x41\x04\xd8\x05\x32\x75\x64\x2a\x1a\xe4\x69\x4e" \
                           "\xc5\x85\x12\xc7\x2a\xcb\x70\xe9\x8a\xd7\x1d\x9e\x68\xd2\x19\xe8" \
                           "\x2a\xed\xf6\x66\xea\x74\x24\x27\xa0\xcf\xd1\x86\x01\x19\x52\x0d" \
                           "\xff\x2c\x85\x66\x0d\x8b\xe8\xc6\x1c\x9f\x9c\x22\x48\x2f\x9a\x2f" \
                           "\x76\xc7\x64\x0d\x88\x0a" \
                           "\x00\x00\x00\x00"

#define ECDSA_SIGNATURE "\x00\x00\x00\x69\x0e\x00\x00\x00\x64\x00\x00\x00\x13\x65\x63\x64" \
                        "\x73\x61\x2d\x73\x68\x61\x32\x2d\x6e\x69\x73\x74\x70\x32\x35\x36" \
                        "\x00\x00\x00\x49\x00\x00\x00\x21\x00\xed\x26\x02\x08\xde\x3f\x9e" \
                        "\x78\xb5\xd0\x2e\xbc\x9d\xc9\xef\x63\x54\xeb\xcf\x98\x2d\x48\xe6" \
                        "\xd2\x97\x35\x6b\x1d\x45\xbd\x7b\x5c\x00\x00\x00\x20\x06\x20\xf8" \
                        "\x54\x43\xef\x72\x55\x0a" \
                        "\x95\x2b\xfc\x30\xfb\xa4\xe0\xf6\x59\x24\x3d\x46\x98\xf1\xe7\x06" \
                        "\x19\x36\x95\x1d\x7d\x54\xe4"
...
test_read_write_rsa (Test *test, gconstpointer unused)
{
	...
	g_assert (ret);
	g_assert (strcmp(stype, "ssh-rsa") == 0);
	...
	g_assert (memcmp (priv_attr->value, pub_attr->value, priv_attr->length) == 0);
...
test_read_write_dsa (Test *test, gconstpointer unused)
{
	...
	ret = egg_buffer_get_string (&buffer, 5, &offset, &stype, (EggBufferAllocator)g_realloc);
	g_assert (ret);
	g_assert (strcmp(stype, "ssh-dss") == 0);
...
test_read_write_ecdsa (Test *test, gconstpointer unused)
{
	...
	ret = egg_buffer_get_string (&buffer, 5, &offset, &stype, (EggBufferAllocator)g_realloc);
	g_assert (ret);
	g_assert (strcmp(stype, "ecdsa-sha2-nistp256") == 0);
